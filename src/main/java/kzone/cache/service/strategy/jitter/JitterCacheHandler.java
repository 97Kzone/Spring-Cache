package kzone.cache.service.strategy.jitter;
...
public class JitterCacheHandler implements KzoneCacheHandler {
    ...
    private Duration applyJitter(Duration ttl) {
        ...
        // -3 이상, 3 이하
        RandomGenerator.getDefault().nextInt(-JITTER_RANGE_SECONDS, JITTER_RANGE_SECONDS + 1);
        return ttl.plusSeconds(JITTER_RANGE_SECONDS);
    }
