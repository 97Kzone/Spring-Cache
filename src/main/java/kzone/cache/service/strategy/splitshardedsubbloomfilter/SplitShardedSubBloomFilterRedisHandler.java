...
import kzone.cache.service.strategy.splitshardedbloomfilter.SplitShardedBloomFilterRedisHandler;
...
public class SplitShardedSubBloomFilterRedisHandler {
    ...
    private void appendSubFilterIfFull(SplitShardedSubBloomFilter splitShardedSubBloomFilter,
        ...
        String distributedLockKey = genSubFilterCountDistributedLockKey(activated);
    ...
    private String genSubFilterCountDistributedLockKey(SplitShardedBloomFilter splitShardedBloomFilter) {
        return "spit-sharded-sub-bloom-filter:sub-filter-count%s:distributed-lock"
